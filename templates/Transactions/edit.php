 ...
 * @var string[]|\Cake\Collection\CollectionInterface $payers
 * @var string[]|\Cake\Collection\CollectionInterface $payees
 */
?>
<div class="row">
    <aside class="column">
    ...
    <div class="column column-80">
        <div class="transactions form content">
            ...
            <fieldset>
                ...
                <?php
                    echo $this->Form->control('payer_id', ['options' => $payers]);
                    echo $this->Form->control('payee_id', ['options' => $payees]);
